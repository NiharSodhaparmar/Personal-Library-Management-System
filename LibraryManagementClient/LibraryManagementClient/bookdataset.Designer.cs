...
namespace LibraryManagementClient {
    ...
    public partial class bookdataset : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, string Edition, string Pages, string Price) {
...
namespace LibraryManagementClient.bookdatasetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([BId] = @Original_BId) AND ([Title] = @Original" +
                "_Title) AND ([Author] = @Original_Author) AND ([Edition] = @Original_Edition) AN" +
                "D ([Pages] = @Original_Pages) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Title], [Author], [Edition], [Pages], [Price]) VALUES" +
                " (@Title, @Author, @Edition, @Pages, @Price);\r\nSELECT BId, Title, Author, Editio" +
                "n, Pages, Price FROM Books WHERE (BId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [Edition] = @Edition, [Pages] = @Pages, [Price] = @Price WHERE (([BId] = @Original_BId) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ([Edition] = @Original_Edition) AND ([Pages] = @Original_Pages) AND ([Price] = @Original_Price));
SELECT BId, Title, Author, Edition, Pages, Price FROM Books WHERE (BId = @BId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryManagementClient.Properties.Settings.Default.LibraryDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BId, Title, Author, Edition, Pages, Price FROM dbo.Books";
        ...
        public virtual int Delete(int Original_BId, string Original_Title, string Original_Author, string Original_Edition, string Original_Pages, string Original_Price) {
            ...
            if ((Original_Edition == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Edition));
            }
            if ((Original_Pages == null)) {
                throw new global::System.ArgumentNullException("Original_Pages");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_Pages));
            }
        ...
        public virtual int Insert(string Title, string Author, string Edition, string Pages, string Price) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, string Edition, string Pages, string Price, int Original_BId, string Original_Title, string Original_Author, string Original_Edition, string Original_Pages, string Original_Price, int BId) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            if ((Original_Pages == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Pages));
            }
            if ((Original_Price == null)) {
                throw new global::System.ArgumentNullException("Original_Price");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Edition, string Pages, string Price, int Original_BId, string Original_Title, string Original_Author, string Original_Edition, string Original_Pages, string Original_Price) {
            return this.Update(Title, Author, Edition, Pages, Price, Original_BId, Original_Title, Original_Author, Original_Edition, Original_Pages, Original_Price, Original_BId);
        }
    }
