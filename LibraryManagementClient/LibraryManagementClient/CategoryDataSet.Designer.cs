...
namespace LibraryManagementClient.CategoryDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Category] WHERE (([CId] = @Original_CId) AND ([Category] = @Or" +
                "iginal_Category))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([Category]) VALUES (@Category);\r\nSELECT CId, Catego" +
                "ry FROM Category WHERE (CId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Category] SET [Category] = @Category WHERE (([CId] = @Original_CId)" +
                " AND ([Category] = @Original_Category));\r\nSELECT CId, Category FROM Category WHE" +
                "RE (CId = @CId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CId, Category FROM dbo.Category";
        ...
        public virtual int Delete(int Original_CId, string Original_Category) {
        ...
        public virtual int Update(string Category, int Original_CId, string Original_Category, int CId) {
            if ((Category == null)) {
                throw new global::System.ArgumentNullException("Category");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Category, int Original_CId, string Original_Category) {
            return this.Update(Category, Original_CId, Original_Category, Original_CId);
        }
    }
